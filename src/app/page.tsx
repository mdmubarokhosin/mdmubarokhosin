          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            >
              <img
                src="/logo.svg"
                alt="MUBAROK Logo"
                className="w-10 h-10 rounded-xl group-hover:scale-110 transition-transform shadow-lg shadow-primary/20"
              />
          ...
          <div className="py-8 md:py-10 flex flex-col md:flex-row items-center justify-between gap-4 border-b border-border/50">
            <div className="flex items-center gap-3.5">
              <img
                src="/logo.svg"
                alt="MUBAROK Logo"
                className="w-12 h-12 rounded-2xl shadow-lg shadow-primary/20"
              />
              <div>
